...
![](img/06_树_2/52%20二叉树中序遍历寻找前驱.jpg)
...
![](img/06_树_2/53%20二叉树中序遍历寻找后继.jpg)
...
![](img/06_树_2/55%20二叉树线索化.jpg)

同理，中序遍历二叉树序列的线索化，可以推广到先序线索二叉树、后序线索二叉树。

![](img/06_树_2/56%20先序遍历线索二叉树.jpg)
![](img/06_树_2/57%20后序遍历线索二叉树.jpg)
...
![](img/06_树_2/59%20中序遍历线索二叉树,左右孩子存在,求其后继.jpg)
...
![](img/06_树_2/60%20中序遍历线索二叉树,左右孩子存在,求其前驱.jpg)
...
![](img/06_树_2/61%20先序遍历线索二叉树,左右孩子存在,求其后继.jpg)
算法实现：
```c
// 找先序线索二叉树p的后继
...
![](img/06_树_2/62%20先序遍历线索二叉树,左右孩子存在,求其前驱.jpg)
...
![](img/06_树_2/63%20后序遍历线索二叉树,左右孩子存在,求其前驱.jpg)
...
![](img/06_树_2/64%20后序遍历线索二叉树,左右孩子存在,求其后继.jpg)
