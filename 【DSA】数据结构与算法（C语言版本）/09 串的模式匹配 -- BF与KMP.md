...
![](img/04_串/13%20子串匹配失败但前若干个匹配成功.jpg)
![](img/04_串/14%20主串不移位置%20子串移至指定位置.jpg)
...
![](img/04_串/25%20google%20next[3].jpg)
...
![](img/04_串/29%20PMT引导KMP算法匹配.jpg)
