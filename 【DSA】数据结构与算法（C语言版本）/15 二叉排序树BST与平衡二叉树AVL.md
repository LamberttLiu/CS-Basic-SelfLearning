...
![](img/06_树_2/93%20BST的删除3.jpg)
![](img/06_树_2/94%20BST的删除4.jpg)
...
![](img/06_树_2/97%20AVL%20二叉平衡树.jpg)
...
![](img/06_树_2/98%20BST插入导致平衡树变成非平衡.jpg)
...
![](img/06_树_2/100%20调整最小不平衡子树_LL.jpg)
...
![](img/06_树_2/101%20调整最小不平衡子树_RR.jpg)
...
![](img/06_树_2/105%20调整最小不平衡子树_RL_1.JPG)
1. 先将A结点的右孩子B的左子树的根结点C向右上旋转，提升到B结点的位置；
2. 然后再把该C结点向左上旋转提升到A结点的位置。

![](img/06_树_2/106%20调整最小不平衡子树_RL_2.JPG)

图中以插入结点在C的左子树CL中，等量换做到CR上依然可以按照相同方法保证调整成功。

![](img/06_树_2/107%20调整最小不平衡子树_RL_3.JPG)
