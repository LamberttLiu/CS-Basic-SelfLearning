...
【预先知识】  
本章虽然属于树的章节内容，但是内容较难，并且涉及到了查找和排序的知识，因此，建议先学习完毕 **查找、排序** 章节后，再阅读本章。
# [55] 二叉排序树
...
![](img/06_树_2/89%20二叉排序树查找成功ASL.jpg)
查找失败的的平均查找长度（ASL）也可以进行计算。

![](img/06_树_2/90%20二叉排序树查找失败ASL.jpg)
...
![](img/06_树_2/91%20AVL%20二叉平衡树.jpg)
