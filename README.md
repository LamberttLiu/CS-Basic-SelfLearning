...
📺 参考：  
主要参考王道考研辅导视频系列，对笔记内容进行了重新归类整理，并重新绘制了清晰美观的图片（主要还是个人对美学要求较高，喜欢配色统一、养眼舒服的插图）。除此以外也纳入一些其他的开源文库补充。  
...
| -------------------------------------------------------- | ---------- | ---------------- | ------------- | ------------ | -------------------- |
| ✅ 数据结构和算法 <br>DataStructure & Algorithm          | 40         | 7k               | 150k          | 300          | ◾◾◾◾◾◾◾◽◽◽ |
| ✅ 操作系统       <br>Operating System                   | 8          | 2k               | 45k           | 80           | ◾◾◽◽◽◽◽◽◽◽ |
...
- [ ] [26 插入排序](【DSA】数据结构与算法（C语言版本）/26%20插入排序.md)
- [ ] [27 希尔排序](【DSA】数据结构与算法（C语言版本）/27%20希尔排序.md)
- [ ] [28 快速排序](【DSA】数据结构与算法（C语言版本）/28%20快速排序.md)
- [ ] [29 选择排序](【DSA】数据结构与算法（C语言版本）/29%20选择排序.md)
...
- [ ] [常用算法 - 贪心](【DSA】数据结构与算法（C语言版本）/常用算法%20-%20贪心.md)
- [ ] [常用算法 - 回溯法](【DSA】数据结构与算法（C语言版本）/常用算法%20-%20回溯法.md)
- [ ] [常用算法 - 分治](【DSA】数据结构与算法（C语言版本）/常用算法%20-%20分治.md)
- [ ] [常用算法 - 前缀和](【DSA】数据结构与算法（C语言版本）/常用算法%20-%20前缀和.md)
- [ ] [常用算法 - 单调栈](【DSA】数据结构与算法（C语言版本）/常用算法%20-%20单调栈.md)
- [ ] [常用算法 - 动态规划](【DSA】数据结构与算法（C语言版本）/常用算法%20-%20动态规划.md)
...
- [ ] [02 进程管理1 进程初步](【OS】操作系统/02%20进程管理1%20进程初步.md)
- [ ] [03 进程管理2 进程调度](【OS】操作系统/03%20进程管理2%20进程调度.md)
- [ ] [04 进程管理3 进程管理](【OS】操作系统/04%20进程管理3%20进程管理.md)
...
🔗课程链接：[计算机组成原理_王道_哔哩哔哩_bilibili](https://www.bilibili.com/video/BV1ps4y1d73V/?spm_id_from=333.337.search-card.all.click)
