...
![](img/S02%20线性表/13%20链表插入%20给定位序.jpg)

3. 新结点后继为所寻结点的后继，新结点成为所寻结点的后继。

![](img/S02%20线性表/14%20链表插入%20给定位序.jpg)
...
![](img/S02%20线性表/15%20链表插入%20某个指定结点后插元素.jpg)
...
![](img/S02%20线性表/16%20链表插入%20某个指定结点前插元素.jpg)
...
![](img/S02%20线性表/17%20链表插入%20某个指定结点前插元素%20Swap.jpg)
...
![](img/S02%20线性表/18%20链表删除（给定位序）.png)

## 2. 指定结点的删除
方法1：传入头指针，循环寻找 p 的前驱结点
方法2：偷天换日（类似于结点前插的实现）

![](img/S02%20线性表/19%20链表删除（给定结点）.png)
以下以方法2为例的代码
```c
