...
![](img/S02%20线性表/02%20是否传引用&的区别.jpg)
...
![](img/S02%20线性表/03%20顺序表的动态扩充.jpg)
...
![](img/S02%20线性表/04%20顺序表的增加数据.jpg)
...
2. 如果原来的表已经满了，无法继续插入；
![](img/S02%20线性表/05%20顺序表插入例外情况.jpg)
### 修改优化
因此对原代码进行修改：
```cpp
// i指位序，不是数组下标
...
![](img/S02%20线性表/06%20顺序表的删除数据.jpg)
...
GetElem(L, i):
```
![](img/S02%20线性表/07%20顺序表按位查找.jpg)
### 1. 静态数组：
```c
#define MaxSize 10
type struct {
...
![](img/S02%20线性表/08%20顺序表按值查找.jpg)
